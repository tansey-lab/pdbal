...
#############################################
class PyStanRegModel(BayesianModel):
...
###########################
class BayesLogisticRegression(PyStanRegModel):        
...
#### PyStan implementation
###########################
class BayesPoissonRegression(PyStanRegModel):        
    def __init__(self, d:int):
        super().__init__(d=d)
...
#### PyStan implementation
###########################
class BayesBetaRegression(PyStanRegModel):        
