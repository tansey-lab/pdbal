...
bsub -J 'brenton_kendall[1-50]' -W 1:00 -n 3 -e output_logs/brenton_kendall%I.err -o output_logs/brenton_kendall%I.out sh scripts/kendall/brenton.sh

bsub -J 'brenton_regret[1-50]' -W 1:00 -n 3 -e output_logs/brenton_regret%I.err -o output_logs/brenton_regret%I.out sh scripts/regret/brenton.sh
